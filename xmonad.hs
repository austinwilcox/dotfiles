...
myStartupHook :: X ()
myStartupHook = do
    --Only used for 4k screens on Dell Laptop
    ...
    spawnOnce "feh --randomize --bg-fill ~/Pictures/*"  -- feh set random wallpaper
    setWMName "LG3D"
...
myWorkspaces = [" terminal ", " code ", " insomnia ", " www ", " db ", " chat ", " file ", " music ", " vbox "]
